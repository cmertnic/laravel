...
<form method="POST" action="{{route('report.update', $report->id)}}">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <label for="number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Номер автомобиля</label>
